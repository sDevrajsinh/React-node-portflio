...
import { trackVisitorData, fetchSettings } from "./services/apiService";
...
function App() {
  ...
  return (
    <div className={`app-container ${siteSettings?.neonAccents ? 'neon-enabled' : ''}`}>
      <CustomCursor />
      <ErrorBoundary>
        <Routes>
          <Route path="/" element={
            siteSettings?.maintenanceMode ? <Maintenance /> : <PortfolioLayout />
          } />
