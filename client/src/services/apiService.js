...
// In development, it can use localhost or the Render URL
// In production, it should use the Render URL
export const API_BASE_URL = 'https://react-node-portflio.onrender.com';
